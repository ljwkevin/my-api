package com.yd.jpa.service;

import com.yd.jpa.entity.ActivitiResultDto;
...
public class ActServiceImpl implements ActService {
    ...
    public  void deploy(String command){
        if ("deploy".equals(command)) {
            ...
            processEngine.getRepositoryService().createDeployment().name("百果园" + s).addClasspathResource("activiti/Leave.bpmn.xml").deploy();
        }
    }
